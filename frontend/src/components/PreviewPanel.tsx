import { EyeIcon, CodeBracketIcon, ClockIcon, ListBulletIcon, LockClosedIcon, Cog6ToothIcon, ShareIcon } from '@heroicons/react/24/outline'

export default function PreviewPanel() {
  return (
    <div className="flex-1 bg-forest-light flex flex-col">
      {/* Header */}
